...
<script type="text/javascript">
		    ...
		    function cleanCart(){
		    	if(confirm("您是否要清空购物车？")){
		    		location.href="${pageContext.request.contextPath}/product?method=cleanCart";
		    	}
		    }
		</script>
...
<body>
	...
	<div class="container">
		...
		<div style="margin-right: 130px;">
			...
			<div
				...
				<a href="javascript:void(0);" id="clear" onclick="cleanCart()"
	...
	<c:if test="${empty cart }">
		<div align="center" id="div_img">
		  <img alt="" src="/AscotShop/image/cart-empty.png">
		</div>
